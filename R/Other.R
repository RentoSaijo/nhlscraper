...
#' 
#' `statistics_report_configuration()` scrapes the configurations for 
...
#' @examples
#' stats_report_config <- statistics_report_configuration()
#' @export

statistics_report_configuration <- function() {
  nhl_api(
    path = 'en/config',
    type = 's'
  )
...
#' @rdname statistics_report_configuration
#' @export
stats_report_config <- function() {
  statistics_report_configuration()
}
