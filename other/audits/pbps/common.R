...
# Feed capability chunk for season.
...
# Special round robin shootout game ids.
...
# Is strength affecting penalty row.
...
# Is simple extra attacker state.
...
# Map regular season ot start counts.
...
# Lookup expected simple penalty state.
...
# Is intermission administrative event.
...
# Shootout terminal order reason.
...
# Check simple penalty transitions.
...
# Check applicability for dataset.
...
# Build event type timeline table.
...
# Write multi season audit readme.
